...
from extensions.vision.template_matching.domain.results import (
    EvaluatedMatches,
    MatchCandidate,
    TemplateMatchResult,
)
from extensions.vision.template_matching.domain.scores import normalize_unit_score
from extensions.vision.template_matching.domain.suppression import (
    MatchSuppressionPolicy,
)
from extensions.vision.template_matching.ports.engine import TemplateMatchEngine
