...
class FileLocator:
    ...
    def __post_init__(self) -> None:
        path = _normalize_text(self.path, field_name="file locator path")
...
class HttpLocator:
    ...
    def __post_init__(self) -> None:
        url = _normalize_text(self.url, field_name="HTTP locator URL")
        parsed = urlparse(url)
...
TemplateLocator = FileLocator | HttpLocator | PackageLocator
